...
const ProductDetails = async ({ params: { id } }) => {
  ...
  return (
    <div className="container mx-auto p-4 grid grid-cols-1 md:grid-cols-3 gap-3">
      
      <figure>
        <Image
          src={imageUrls[0] ? imageUrls[0] : "https://5.imimg.com/data5/WC/TK/MY-38492074/share-johnson-e2-80-99s-c2-ae-baby-powder-blossoms-500x500.png"}
          alt={title}
          width={450}
          height={450}
          placeholder="blur"
      ...
      <div className="col-span-2 space-x-1 space-y-1">
